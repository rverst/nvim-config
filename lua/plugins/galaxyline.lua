...
gls.short_line_left = {
  ...
  },
  {
    ShortFileName = {
      ...
      highlight = { c.acc1.hex, c.dark3.hex, 'bold' },
    },
  },
  {
    ShortPrintTerm = {
...
gls.short_line_right = {
  {
    ShortBufferType = {
      provider = bufferType,
      condition = all(shortListShow, bufferNotEmpty),
      highlight = { c.border.hex, c.dark3.hex },
    },
  },
  {
    ShortLineColumn = {
      ...
      highlight = { c.acc1.hex, c.dark3.hex },
      separator = ' ',
      separator_highlight = { c.acc1.hex, c.dark3.hex },
    },
  },
}
